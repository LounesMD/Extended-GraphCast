...
def _flatten_datatree(datatree: DataTree) -> Tuple[
    Tuple[Mapping[str, DataTree], xarray.Dataset], str | None]:
...
def _unflatten_datatree(
    aux: str | None,
    children: Tuple[Mapping[str, DataTree], xarray.Dataset],
) -> DataTree:
...
jax.tree_util.register_pytree_node(
    DataTree, _flatten_datatree, _unflatten_datatree)
